...
test <- rawconsumption[event_date>"2021-02-14"]
rawconsumption <- rawconsumption[event_date<="2021-02-14"]
...
```{r, eval = TRUE, error=FALSE, warning=FALSE, message = FALSE, fig.width = 12, include = TRUE}
#test data update?
test$consumption <- rawconsumption$consumption[35977:36024]
test$quant5 <- rawconsumption$quant5[35977:36024]
test$quant25 <- rawconsumption$quant25[35977:36024]
test$quant75 <- rawconsumption$quant75[35977:36024]
test$quant95 <- rawconsumption$quant95[35977:36024]
...
Click [here](https://github.com/BU-IE-360/fall20-blc-gksl/blob/master/files/PR/Group8Report.Rmd) to reach the RMD file.
